...
/*
    ...
    @Created 2025
    @Program Description : Test la fonction de somme des éléments d'une liste
*/

#include "somme_liste.h"
#include "../../A/source/util_rand.h"  // Utilisation de ta bibliothèque pour les nombres aléatoires
#include <stdlib.h>
